...
$lang = array_merge($lang, [
    ...
    "PLUPLOAD_ADD_FILES_TO_QUEUE" =>
        "Zaradiť súbory doradu k nahrávaňú a pokračuvať tlačítkom “Nahrať súbory”.",
    "PLUPLOAD_ALREADY_QUEUED" => "%s už je zaradený.",
    "PLUPLOAD_CLOSE" => "Zavreť",
    "PLUPLOAD_DRAG" => "Presuňte súbory sem.",
    "PLUPLOAD_DUPLICATE_ERROR" => "Chyba, duplicitný výskyt súboru.",
    "PLUPLOAD_DRAG_TEXTAREA" =>
        "Súbory tiež môžete pridať metódou potiahni a pusť do textového okna, v ktorom píšete príspevok.",
    ...
    "PLUPLOAD_ERR_FILE_TOO_LARGE" => "Súbor je tlstý:",
    "PLUPLOAD_ERR_FILE_COUNT" => "Chyba v počte súborov.",
    "PLUPLOAD_ERR_FILE_INVALID_EXT" => "Zlá koncovka súboru:",
    ...
    "PLUPLOAD_IMAGE_FORMAT" => "Formát obrázku je nepodporuvaný.",
    ...
    "PLUPLOAD_START_UPLOAD" => "Začať nahrávaní súborov",
    "PLUPLOAD_START_CURRENT_UPLOAD" =>
        "Spustiť nahrávaní celého toho radu súborov",
    "PLUPLOAD_STOP_UPLOAD" => "Zrušiť nahrávaní",
    "PLUPLOAD_STOP_CURRENT_UPLOAD" => "Zrušiť prebíhajúce nahrávaní",
